...
| Upgrading a project to the latest major `@entur/*` versions, fixing breakage after a dependency bump | [migrate-react-18](https://raw.githubusercontent.com/entur/design-system/main/skills/migrate-react-18/SKILL.md) — a step-by-step upgrade procedure                                                                                                |
| Looking up a single deprecated prop or renamed export                                                | [entur-web-development](https://raw.githubusercontent.com/entur/design-system/main/skills/entur-web-development/SKILL.md) — then its `migration-guide` reference                                                                                  |
...
- Version upgrades / build breakage after bumping `@entur/*` → [migrate-react-18](https://raw.githubusercontent.com/entur/design-system/main/skills/migrate-react-18/SKILL.md)
