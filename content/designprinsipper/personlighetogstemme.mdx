...
description: Hvilken personlighet og stemme har egentlig Entur?
route: /design-prinsipper/personlighet-og-stemme
...
import './personlighetogstemme.scss';

<PageHeader>
  Med utgangspunkt i våre verdier er det skapt tre personlighetstrekk som gir
  Entur en menneskelig, distinkt og tydelig fremtoning.
</PageHeader>
