...
Hvis du har spørsmål, eller sitter fast, ta kontakt på #talk-designsystem på Slack - vi er som regel raske til å svare. Hvis du mangler tilgang til dokumentasjon/skisser i Figma, kontakt [Sara Johansson](mailto:sara.johansson@entur.org).
