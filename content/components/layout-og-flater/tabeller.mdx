...
<Playground>
  {() => {
    ...
    // Første paramter er antall rader som er i tabellen,
    // Andre paramterer er om det skal være sirkulær navigering, dvs. at pil ned på siste rad sender deg til toppen av tabellen.
    return (
      <>
        <Table>
          <TableHead>
