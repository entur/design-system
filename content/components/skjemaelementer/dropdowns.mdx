...
Denne funksjonen blir kalt hver gang man endrer noe i input-feltet, og mottar den nye input-strengen som argument. Funkjsonen kan være asynkron, og vil i så tilfeller vise en spinner mens brukeren venter.
