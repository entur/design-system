---
name: Alerts
description: Varsler brukes for å fange brukerens oppmerksomhet og inneholder korte viktige meldinger som man bør ta hensyn til.
route: /komponenter/feedback/alerts
parent: Komponenter
menu: Feedback
npmPackage: alert
...
<ImportStatement imports="ToastAlertBox, ToastProvider, useToast" />
