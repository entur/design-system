...
parent: Komponenter
route: /komponenter/ressurser/ikoner
menu: Ressurser
npmPackage: icons
tags: ikoner, icons
---
...
Ikoner er også støttet for React Native, ved å importere fra `@entur/icons/native`. Props som er støttet er `color` og `size`.

Slik:

```
import { SeatIcon } from '@entur/icons/native'
