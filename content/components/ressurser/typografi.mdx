...
For å benytte seg av fonten, så må man legge den til som en avhengighet i `package.json` med en link til bitbucket:

```json
"dependencies": {
  "@entur/fonts": "ssh://git@bitbucket.org:enturas/entur-fonts.git#master"
}
```
