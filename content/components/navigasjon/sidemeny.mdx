...
<Playground>
  <CollapsibleSideNavigation collapsible>
    ...
    <SideNavigationGroup title="Andre alternativer" icon={<MenuIcon />}>
      <SideNavigationItem icon={<CalenderIcon />} href="#kalender">
        Kalender
      </SideNavigationItem>
    </SideNavigationGroup>
  </CollapsibleSideNavigation>
...
<Paragraph>
  ...
  <LinkText as={Link} to="/komponenter/navigasjon/top-navigation">
    Top navigation
  </LinkText>{' '}
