...
Entur har tatt initiativ til en en undersøkelse på hvilken informasjon ulike trafikantgrupper med funksjonsnedsettelser trenger
og etterspør når de skal reise kollektivt. Undersøkelsen er gjennomført av Opinion våren 2019. Resultatene og kunnskapen skal
benyttes til å forbedre informasjonen i digitale reiseplanleggere, og dermed kunne bidra til at flere med funksjonsnedsettelse
kan velge å reise kollektivt. Målgruppene for studien er personer med nedsatt bevegelse, syn, hørsel og kognitiv svikt.
...
Hvis du har noen spørsmål om universell utforming eller trenger noen å sparre med på et spesifikt problem, kan du kontakte Designsystemet på Slack i #talk-designsystem. Vi kan også hjelpe til ved testing med skjermleser.
...
Viktige fokusområder for å dekke nødvendige krav for i digitale løsninger er:
