...
<Props of={Table} title="Props, Table" defaultOpen={false} />
...
<Props of={TableHead} title="Props, TableHead" defaultOpen={false} />
<Props of={TableBody} title="Props, TableBody" defaultOpen={false} />
<Props of={TableFooter} title="Props, TableFooter" defaultOpen={false} />

### TableRow

`<TableRow />` er en rad i tabellen, og inneholder enten `<HeaderCell />`- eller `<DataCell />`-komponenter.

<Props of={TableRow} title="Props, TableRow" defaultOpen={false} />
...
<Props of={HeaderCell} title="Props, HeaderCell" defaultOpen={false} />
...
<Props of={DataCell} title="Props, DataCell" defaultOpen={false} />
