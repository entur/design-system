...
description: Entur sitt designsystem er utviklet for å være universelt utformet. Det betyr at det skal kunne fungere for alle. Her finner du noen ekstra komponenter for å forenkle dette arbeidet i løsningene våre også.
...
<ImportStatement imports="SkipToContent" packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="SkipToContent" />

### VisuallyHidden

<ImportStatement imports="VisuallyHidden" packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="VisuallyHidden" />
