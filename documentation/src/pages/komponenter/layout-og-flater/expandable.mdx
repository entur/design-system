...
<Playground style={{ alignItems: 'start' }} code={`<ExpandableText title="Se mer info" >
...
<ImportStatement imports="ExpandablePanel"  packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="ExpandablePanel" />

### ExpandableText

<ImportStatement imports="ExpandableText"  packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="ExpandableText" />

### Accordion og AccordionItem

<ImportStatement imports="Accordion, AccordionItem"  packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="Accordion" title="Props, Accordion" />
<Props componentName="AccordionItem" title="Props, AccordionItem" />

### ExpandableTextButton

<ImportStatement imports="ExpandableTextButton"  packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="ExpandableTextButton" />

### BaseExpand

<ImportStatement imports="BaseExpand"  packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="BaseExpand" />

### ExpandArrow

<ImportStatement imports="ExpandArrow"  packageName={props.pageContext.frontmatter.npmPackage} />
<Props componentName="ExpandArrow" />
