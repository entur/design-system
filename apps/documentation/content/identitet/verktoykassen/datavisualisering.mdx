...
<ImageDisplay
  fluidSource={props.data.files.images.find(image => image.name === "DatavisualiseringVektlegging")?.childImageSharp.fluid}
...
<DoDontGroup>
  <DoDontCard 
    variant="warning" 
    fluidSource={props.data.files.images.find(image => image.name === "dataDont1")?.childImageSharp.fluid} 
  ...
  <DoDontCard 
    variant="warning"     
    fluidSource={props.data.files.images.find(image => image.name === "dataDont2")?.childImageSharp.fluid} 
