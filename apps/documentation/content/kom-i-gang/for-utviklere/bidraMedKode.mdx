...
Repoet er tilgjengelig på [BitBucket](https://bitbucket.org/enturas/design-system/src) (Merk at du må være i Entur for å ha tilgang til dette repoet). For å klone det, må du sette opp en ssh-nøkkel på Mac-en din og legge til den offentlige nøkkelen i BitBucket-kontoen din (dvs. autentisere datamaskinen din). Hvis du allerede har gjort dette, kan du hoppe over neste trinn.

- Følg [BitBuckets veiledning](https://support.atlassian.com/bitbucket-cloud/docs/set-up-personal-ssh-keys-on-macos/) om hvordan du setter opp SSH-nøkkeltilkoblingen din.
...
7. Push endringene dine til BitBucket
