...
<SmallAlertBox variant="warning" width="fit-content">
  <CodeText>Table</CodeText> sine props vises ikke pga en bug. De viktigste er
  nevnt under.
</SmallAlertBox>
<Props of={Table} />
  ...
  <div style={{ width: '100%', height: '25rem', overflowY: 'scroll' }}>
    <Table stickyHeader>
      ...
      <TableBody>
        ...
        <TableRow>
          <DataCell>Barn 6-10 år</DataCell>
          <DataCell>Standard</DataCell>
          <DataCell>2</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Barn 11-15 år</DataCell>
          <DataCell>Standard</DataCell>
          <DataCell>2</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Barn 16-20 år</DataCell>
          <DataCell>Standard</DataCell>
          <DataCell>3</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Barn 21-25 år</DataCell>
          <DataCell>Standard</DataCell>
          <DataCell>4</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Gammelt barn</DataCell>
          <DataCell>Standard</DataCell>
          <DataCell>4</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Ung voksen</DataCell>
          <DataCell>Komfort</DataCell>
          <DataCell>5</DataCell>
        </TableRow>
        <TableRow>
        ...
        <TableRow>
          <DataCell>Gammel Voksen</DataCell>
          <DataCell>Komfort</DataCell>
          <DataCell>6</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Ung senior</DataCell>
          <DataCell>Standard</DataCell>
          <DataCell>6</DataCell>
        </TableRow>
        <TableRow>
          <DataCell>Gammel senior</DataCell>
          <DataCell>Fleksi</DataCell>
          <DataCell>7</DataCell>
        </TableRow>
      </TableBody>
    </Table>
