...
<Playground props={banner}>
  <BannerAlertBox variant="information"></BannerAlertBox>
</Playground>
...
Toasts er kun tilgjengelige i typene success og information, men vi bruker for det meste success-varselet.
...
#### Toasts og universell utforming
