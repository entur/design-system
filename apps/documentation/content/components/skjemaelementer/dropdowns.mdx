...
<Playground style={{ overflow: 'visible', margin: 'auto', width: '70%' }}>
  {() => {
...
liste med `NormalizedDropdownItemType` direkte eller gjennom et `Promise`. OBS: du må huske å [memoisere funksjonen](https://react.dev/reference/react/useCallback) ved å bruke
