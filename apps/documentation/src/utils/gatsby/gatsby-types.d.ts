...
type MdxFrontmatter = {
  ...
  readonly removeToc: Maybe<Scalars['Boolean']>;
...
type MdxFrontmatterFieldSelector = {
  ...
  readonly removeToc: InputMaybe<FieldSelectorEnum>;
...
type MdxFrontmatterFilterInput = {
  ...
  readonly removeToc: InputMaybe<BooleanQueryOperatorInput>;
...
type MdxFrontmatterSortInput = {
  ...
  readonly removeToc: InputMaybe<SortOrderEnum>;
...
type NpmPackageConnection = {
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly edges: ReadonlyArray<NpmPackageEdge>;
  readonly group: ReadonlyArray<NpmPackageGroupConnection>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly nodes: ReadonlyArray<NpmPackage>;
  readonly pageInfo: PageInfo;
  readonly sum: Maybe<Scalars['Float']>;
  readonly totalCount: Scalars['Int'];
};
...
type NpmPackageConnection_distinctArgs = {
  field: NpmPackageFieldSelector;
};


type NpmPackageConnection_groupArgs = {
  field: NpmPackageFieldSelector;
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
};
...
type NpmPackageConnection_maxArgs = {
  field: NpmPackageFieldSelector;
};


type NpmPackageConnection_minArgs = {
  field: NpmPackageFieldSelector;
};


type NpmPackageConnection_sumArgs = {
  field: NpmPackageFieldSelector;
};

type NpmPackageEdge = {
  readonly next: Maybe<NpmPackage>;
  readonly node: NpmPackage;
  readonly previous: Maybe<NpmPackage>;
};

type NpmPackageFieldSelector = {
  readonly children: InputMaybe<NodeFieldSelector>;
  readonly id: InputMaybe<FieldSelectorEnum>;
  readonly internal: InputMaybe<InternalFieldSelector>;
  readonly name: InputMaybe<FieldSelectorEnum>;
...
type NpmPackageGroupConnection = {
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly edges: ReadonlyArray<NpmPackageEdge>;
  readonly field: Scalars['String'];
  readonly fieldValue: Maybe<Scalars['String']>;
...
type NpmPackageGroupConnection_distinctArgs = {
  field: NpmPackageFieldSelector;
};


type NpmPackageGroupConnection_groupArgs = {
  field: NpmPackageFieldSelector;
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
};
...
type NpmPackageGroupConnection_maxArgs = {
  field: NpmPackageFieldSelector;
};


type NpmPackageGroupConnection_minArgs = {
  field: NpmPackageFieldSelector;
};


type NpmPackageGroupConnection_sumArgs = {
  field: NpmPackageFieldSelector;
};

type NpmPackageSortInput = {
  readonly children: InputMaybe<NodeSortInput>;
  readonly id: InputMaybe<SortOrderEnum>;
  readonly internal: InputMaybe<InternalSortInput>;
  readonly name: InputMaybe<SortOrderEnum>;
...
type Query = {
  ...
  readonly allNpmPackage: NpmPackageConnection;
  ...
  readonly npmPackage: Maybe<NpmPackage>;
...
type Query_allNpmPackageArgs = {
  filter: InputMaybe<NpmPackageFilterInput>;
  limit: InputMaybe<Scalars['Int']>;
  skip: InputMaybe<Scalars['Int']>;
  sort: InputMaybe<ReadonlyArray<InputMaybe<NpmPackageSortInput>>>;
};
...
type IconsQueryQueryVariables = Exact<{ [key: string]: never; }>;


type IconsQueryQuery = { readonly allFile: { readonly edges: ReadonlyArray<{ readonly node: { readonly publicURL: string | null, readonly name: string, readonly absolutePath: string } }> } };
...
type indexQueryQuery = { readonly index: { readonly index: string, readonly store: Record<string, unknown> } | null };
...
type NpmVersionQuery = { readonly allNpmPackage: { readonly edges: ReadonlyArray<{ readonly node: { readonly version: string | null, readonly name: string | null } }> } };

type PackageChangelogQueryVariables = Exact<{ [key: string]: never; }>;


type PackageChangelogQuery = { readonly allFile: { readonly nodes: ReadonlyArray<{ readonly name: string, readonly publicURL: string | null, readonly children: ReadonlyArray<{ readonly id: string } | { readonly id: string } | { readonly id: string } | { readonly id: string } | { readonly id: string, readonly body: string | null } | { readonly id: string } | { readonly id: string } | { readonly id: string } | { readonly id: string } | { readonly id: string } | { readonly id: string } | { readonly id: string }> }> } };

type pageQueryQueryVariables = Exact<{ [key: string]: never; }>;


type pageQueryQuery = { readonly stilogtone: { readonly images: ReadonlyArray<{ readonly name: string, readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null }> } };
