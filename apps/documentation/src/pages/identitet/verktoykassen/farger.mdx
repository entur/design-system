...
<ImageDisplay
  ...
  preset="full-width-image"
/>
<Paragraph>beskrivelse</Paragraph>
...
<DoDontGroup>
    <DoDontCard
      contrast
      variant="negative"
      imgSource={props.data.files.images.find(image => image.name === "blue").childImageSharp.gatsbyImageData}
      alt=""
      noPadding
    >
        <Paragraph>Aldri mørk tekst på blå bakgrunn</Paragraph>
    </DoDontCard>
    <DoDontCard
      contrast
      variant="negative"
      imgSource={props.data.files.images.find(image => image.name === "coral").childImageSharp.gatsbyImageData}
      alt=""
      noPadding
    >
        <Paragraph>Aldri korall som bakgrunn</Paragraph>
    </DoDontCard>
    <DoDontCard
      contrast
      variant="negative"
      imgSource={props.data.files.images.find(image => image.name === "grey").childImageSharp.gatsbyImageData}
      alt=""
      noPadding
    >
    <Paragraph>Aldri kombinasjoner som ikke er identitetsbærende</Paragraph>
    </DoDontCard>
    <DoDontCard
      contrast
      variant="negative"
      imgSource={props.data.files.images.find(image => image.name === "white").childImageSharp.gatsbyImageData}
      alt=""
      noPadding
    >
        <Paragraph>Aldri peach farge på lys bakgrunn</Paragraph>
    </DoDontCard>
  </DoDontGroup>
...
Kontrastkravene er:
- Stor tekst: minst 3.0:1
- Liten tekst: minst 4.5:1
