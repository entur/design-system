...
query coBrandingFiles {
  files: allFile(filter: {sourceInstanceName: {eq: "media"}, relativeDirectory: {glob: "images/identitet/verktoykassen/co_branding"}, extension: {eq: "png"}}) {
    images: nodes {
      name
      childImageSharp {
         gatsbyImageData(
...
<ImageDisplay
  imgSource={props.data.files.images.find(image => image.name === "Co-brand 2").childImageSharp.gatsbyImageData}
  alt=""
  preset="full-width-image"
/>
...
<ImageDisplay
  imgSource={props.data.files.images.find(image => image.name === "Co-brand 4").childImageSharp.gatsbyImageData}
...
<ImageDisplay
  imgSource={props.data.files.images.find(image => image.name === "Co-brand 6").childImageSharp.gatsbyImageData}
...
<ImageDisplay
  imgSource={props.data.files.images.find(image => image.name === "Co-brand 7").childImageSharp.gatsbyImageData}
...
<ImageDisplay
  imgSource={props.data.files.images.find(image => image.name === "Co-brand 8").childImageSharp.gatsbyImageData}
