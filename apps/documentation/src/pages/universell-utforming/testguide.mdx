...
## 9. Video og synstolking

- Har forhåndsinnspilt video med viktig visuell informasjon [synstolking](https://www.uutilsynet.no/regelverk/fra-i-dag-skal-nye-videoopptak-i-offentleg-sektor-ha-synstolking/2128)? Lovpålagt for offentlig sektors video publisert etter 1. februar 2024 (WCAG 1.2.5, nivå AA).
- Har video med tale teksting, slik at hørselshemmede får med seg innholdet?
- Direktesendinger er unntatt kravet – men blir opptaket liggende tilgjengelig etterpå, må det synstolkes innen 14 dager.

Se [Uu-tilsynets løsningsforslag for synstolking](https://www.uutilsynet.no/veiledning/125-synstolking-forhandsinnspilt/1927) for konkrete eksempler.

## 10. Automatiserte verktøy

Bruk disse som et første lag – se innledningen for hvor mye de faktisk fanger:
