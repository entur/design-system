...
Høyder, padding, ikonstørrelser og typografi kommer fra tokens som følger
[visningsmodus](/tokens/storrelsetokens/visningsmodus), så chips-ene skalerer innenfor hver `size`
når `data-view-mode` er satt på en parent.
