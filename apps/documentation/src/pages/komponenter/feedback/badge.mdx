...
Tag dekker begge bruksområdene `StatusBadge` hadde: statusmarkering med `success`, `warning`, `negative` og `information`, og kategorimerking med ni fargevarianter i tillegg til `neutral`.
