...
route: /tokens/fargetokens/dark-mode
parent: Tokens
menu: Fargetokens
order: 3
---
...
Om deler av din løsning ikke bruker designsystemets komponenter og du ønsker å støtte darkmode kan du bruke tokens fra `base.css` , `base`-stilsettet støtter dark-mode. Sjekk ut [oversikt over base-tokens](/tokens/fargetokens/oversikt#base). 
