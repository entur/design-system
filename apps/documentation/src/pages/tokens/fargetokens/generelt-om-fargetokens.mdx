...
route: /tokens/fargetokens/generelt-om-fargetokens
parent: Tokens
menu: Fargetokens
order: 1
---
...
Om du skal lage noe vi ikke tilbyr via komponenter skal du bruke base-tokens, se [oversikt over base-tokens](/tokens/fargetokens/oversikt#base). Base-fargene har støtte for dark-mode. Disse er bygget på «semantic colors» slik at det skal være tydelig hvordan de skal brukes, og hvor de skal brukes. 
