...
export const shadows = {
  ...
  cardShadow: `0 2px 3px 0 ${colors.greys.grey10}`, //B3 er 70% alpha
  cardShadowHover: `0 2px 16px 0 ${colors.greys.grey10}`,
  cardShadowContrast: `0 2px 3px 0 ${colors.blues.blue20}`, //B3 er 70% alpha
  cardShadowHoverContrast: `0 2px 16px 0 ${colors.blues.blue20}`,
};
